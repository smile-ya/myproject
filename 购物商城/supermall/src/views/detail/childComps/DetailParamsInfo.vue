<template>
  <div class="param-info" v-if="Object.keys(paramInfo).length !==0">
    <table v-for="(itable,index) in paramInfo.rule.tables"
           class="info-size" :key="index">
      <tr v-for="(itr,indey) in itable" :key="indey">
        <td v-for="(itd,indez) in itr" :key="indez">{{itd}}</td>
      </tr>
    </table>
    ...
    <div class="info-img" v-if="paramInfo.info.images">
      <img v-lazy="paramInfo.info.image[0]" alt="">
    </div>
